...
class UserService(service_pb2_grpc.UserServiceServicer):
    def Register(self, request, context):
        ...
        if not username or not email or not password:
            return service_pb2.UserResponse(success=False, message="Username, email, and password cannot be empty")
    ...
    def Login(self, request, context):
        ...
        if not email or not password:
            return service_pb2.LoginResponse(success=False, token="Email and password cannot be empty")
