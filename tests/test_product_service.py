...
def test_get_products_db_fallback(product_service, mocker):
    mock_get_cache = mocker.patch('app.services.product_service.get_cached_data', return_value=None)
    ...
    Product.query.limit.return_value.offset.return_value.all.return_value = [mock_product]
