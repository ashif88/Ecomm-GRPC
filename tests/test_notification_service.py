...
def test_send_email_success(notification_service, mocker):
    ...
    request = service_pb2.NotificationRequest(subject="Test Subject", body="Test Body", recipient="test@test.com")
    context = MagicMock()
    ...
    mock_send_message.assert_called_once_with('email_topic', 'To: test@test.com, Subject: Test Subject, Body: Test Body')
