...
def test_register_success(user_service, mocker):
    ...
    request = service_pb2.UserRequest(username="test_user", email="test@test.com", password="password123")
    context = MagicMock()
...
def test_register_empty_fields(user_service, mocker):
    request = service_pb2.UserRequest(username="", email="test@test.com", password="password123")
    context = MagicMock()
...
def test_register_duplicate_user(user_service, mocker):
    ...
    User.query.filter.return_value.first.return_value = User(username="test_user", email="test@test.com")
